...
{
    public class Fragment_Favorite_LayBy : BaseFragment
    {
        ...
        public static Fragment_Favorite_LayBy NewInstance()
        {
            var frag1 = new Fragment_Favorite_LayBy { Arguments = new Bundle() };
            return frag1;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            thread.loadRSA(FavoriteType.LAYBY);
