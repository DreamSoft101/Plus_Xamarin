...
{
    public class Fragment_PertrolStation : BaseFragment
    {
        ...
        public static Fragment_PertrolStation NewInstance()
        {
            var frag1 = new Fragment_PertrolStation { Arguments = new Bundle() };
            return frag1;
        }
