...
{
    public class Fragment_LiveTraffic_All : BaseFragment
    {
        ...
        public static Fragment_LiveTraffic_All NewInstance()
        {
            var frag1 = new Fragment_LiveTraffic_All { Arguments = new Bundle() };
            return frag1;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            //    adapter = new LiveTrafficAdapter(getActivity(), lstItem);
            //    mLstItems.SetAdapter(adapter);
            //};
            //thread.loadLiveTraffic(new List<int>() { 0 }, "HWY0000000001");
            return view;
        }
