...
{
    public class Fragment_Favorites_CSC : BaseFragment
    {
        ...
        public static Fragment_Favorites_CSC NewInstance()
        {
            var frag1 = new Fragment_Favorites_CSC { Arguments = new Bundle() };
            return frag1;
        }
