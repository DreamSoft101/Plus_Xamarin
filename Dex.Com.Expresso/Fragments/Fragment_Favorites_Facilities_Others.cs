...
{
    public class Fragment_Favorites_Facilities_Others : BaseFragment
    {
        ...
        public static Fragment_Favorites_Facilities_Others NewInstance(FacilitiesType type)
        {

            var frag1 = new Fragment_Favorites_Facilities_Others { mOtherTypes = type };
            return frag1;
        }
