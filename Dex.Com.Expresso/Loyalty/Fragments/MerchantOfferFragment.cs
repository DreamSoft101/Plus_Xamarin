...
{
    public class MerchantOfferFragment : BaseFragment
    {
        private ListView mLstView;
        private MerchantProductsItemsAdapter adapter;
        public static MerchantOfferFragment NewInstance()
        {
            var frag1 = new MerchantOfferFragment { Arguments = new Bundle() };
            return frag1;
        }
