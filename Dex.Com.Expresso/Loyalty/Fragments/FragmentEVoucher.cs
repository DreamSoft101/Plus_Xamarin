...
{
    public class FragmentEVoucher : BaseFragment
    {
        ...
        public static FragmentEVoucher NewInstance()
        {
            var frag1 = new FragmentEVoucher { Arguments = new Bundle() };
            return frag1;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            EVoucherAdapters adapter = new EVoucherAdapters(getActivity(), getActivity().SupportFragmentManager);
