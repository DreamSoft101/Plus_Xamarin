...
{
    public class MerchantOfferFavoritesFragment : BaseFragment
    {
        private ListView mLstView;
        private MerchantProductsItemsAdapter adapter;
        public static MerchantOfferFavoritesFragment NewInstance()
        {
            var frag1 = new MerchantOfferFavoritesFragment { Arguments = new Bundle() };
            return frag1;
        }
