...
{
    public class POITypeAdapter : RecyclerView.Adapter
    {
        public event EventHandler<POITypeSetting> ItemClick;
        private Context mContext;
        private List<POITypeSetting> mLstItem;
        public POITypeAdapter(Context conext)
        {
            this.mContext = conext;
            mLstItem = (conext as BaseActivity).getFavoritePOIType();
        ...
        private class BaseViewHolder : RecyclerView.ViewHolder
        {
            ...
            public POITypeSetting mBaseItem;
