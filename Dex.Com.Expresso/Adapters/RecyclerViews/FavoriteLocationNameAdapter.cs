...
{
    public class FavoriteLocationNameAdapter : RecyclerView.Adapter
    {
        public event EventHandler<FavoriteLocation> ItemClick;
        private Context mContext;
        private List<FavoriteLocation> mLstItem;
        public FavoriteLocationNameAdapter(Context conext)
        {
        ...
        public FavoriteLocation GetBaseItem(int pos)
        {
            return mLstItem[pos];
        }
        ...
        private class BaseViewHolder : RecyclerView.ViewHolder
        {
            ...
            public FavoriteLocation mBaseItem;
        ...
        {
            View itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.exp_item_favorite_location_spn_filter, parent, false);
