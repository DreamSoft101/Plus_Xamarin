...
namespace Dex.Com.Expresso.Adapters.RecyclerViews
{
    public class ImageAdapter : RecyclerView.Adapter
    {
        ...
        public ImageAdapter(Context conext, List<string> urls)
        {
        ...
        {
            View itemView = LayoutInflater.From(parent.Context).Inflate(Resource.Layout.exp_item_imageview, parent, false);
